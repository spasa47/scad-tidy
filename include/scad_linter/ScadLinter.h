...
namespace scad_linter {
    ...
    public:
        ...
        std::any visitLiteralExpression(parser::ScadParser::LiteralExpressionContext *context) override;
        std::any visitLiteral(parser::ScadParser::LiteralContext *context) override;
        std::any visitAssignmentOperator(parser::ScadParser::AssignmentOperatorContext *context) override;
        ...
        std::any visitFunction_declaration(parser::ScadParser::Function_declarationContext *context) override;
        ...
        std::any visitDebugableStatement(parser::ScadParser::DebugableStatementContext *context) override;
        ...
        std::any visitModuleDeclaration(parser::ScadParser::ModuleDeclarationContext *context) override;
        std::any visitModuleDeclarationHeader(parser::ScadParser::ModuleDeclarationHeaderContext *context) override;
        ...
        std::any visitVariableAssignment(parser::ScadParser::VariableAssignmentContext *context) override;
        ...
        std::any visitBoolComparisonOperator(parser::ScadParser::BoolComparisonOperatorContext *context) override;
        std::any visitBoolBinaryOperator(parser::ScadParser::BoolBinaryOperatorContext *context) override;
        std::any visitBoolUnaryOperator(parser::ScadParser::BoolUnaryOperatorContext *context) override;
        ...
        std::any visitRangeAssignmentList(parser::ScadParser::RangeAssignmentListContext *context) override;
